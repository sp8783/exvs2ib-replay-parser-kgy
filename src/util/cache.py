...
class CacheManager:
    ...
    def __init__(self, cache_dir, video_basename):
    ...
    def save_frames_cache(self, frame_paths):
        """
        フレーム抽出結果をキャッシュに保存する。
        """
    ...
    def save_screens_cache(self, screens, match_count):
        """
        画面判定結果をキャッシュに保存する。
        """
